...
#finds an open port to bind services to
def getOpenPort():
...
class ServiceProvidingNode:
    ...
    #format the registration as a serializable json request
    def formatRegisterRequest(self):
        ...
        #note that this only will every open ports on local 
        #TODO: allow public ip connection for real network communication
